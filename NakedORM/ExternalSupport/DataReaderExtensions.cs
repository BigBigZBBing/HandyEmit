...
namespace Core.Repository.ExternalSupport
{
    public static class DataReaderExtensions
    {
            ...
            where T : class, new()
        {
            ...
            //private static Func<IDataReader, List<T>> DbRead<T>(List<EmitProperty> emits)
            //{
            //    DynamicMethod dm = new DynamicMethod(string.Empty, typeof(List<T>), new Type[] { typeof(IDataReader) });
            //    //初始化IL生成器
            ...
            //    //获取所有字段的位置
            //    LocalBuilder[] Propertys = GetColumnIndices(il, emits);
            ...
            //    BuildItem<T>(il, emits, item, Propertys);
